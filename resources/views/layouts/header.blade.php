<header class="bg-white shadow-md">
    <nav class="container mx-auto px-6 py-3 flex justify-between items-center">
        ...
        <div class="flex items-center">
            ...
            <a href="{{ route('services') }}" class="text-gray-600 hover:text-indigo-600 mx-4">Найти услугу</a>
            @if(auth()->user())
    ...
    @if(auth()->user() && auth()->user()->is_activated == 0 && auth()->user()->type == 'seller')
    ...
    @elseif(auth()->user() && auth()->user()->is_activated == 0 && auth()->user()->type == 'buyer')
        <div class="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4" role="alert">
            <p class="font-bold">Внимание!</p>
